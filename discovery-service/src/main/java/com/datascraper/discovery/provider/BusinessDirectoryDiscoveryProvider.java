...
@Component
public class BusinessDirectoryDiscoveryProvider implements DiscoveryProvider {

    static final String PROVIDER_NAME = "Business Directory";

    private final DiscoveryProperties discoveryProperties;

    public BusinessDirectoryDiscoveryProvider(DiscoveryProperties discoveryProperties) {
        this.discoveryProperties = discoveryProperties;
    }

    @Override
    public DiscoveryProviderType type() {
        return DiscoveryProviderType.BUSINESS_DIRECTORY;
    }
    ...
    public boolean enabled() {
        return discoveryProperties.isEnabled(DiscoveryProviderType.BUSINESS_DIRECTORY);
    }
