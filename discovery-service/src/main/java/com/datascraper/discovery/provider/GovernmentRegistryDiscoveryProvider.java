...
@Component
public class GovernmentRegistryDiscoveryProvider implements DiscoveryProvider {

    static final String PROVIDER_NAME = "Government Registry";

    private final DiscoveryProperties discoveryProperties;

    public GovernmentRegistryDiscoveryProvider(DiscoveryProperties discoveryProperties) {
        this.discoveryProperties = discoveryProperties;
    }

    @Override
    public DiscoveryProviderType type() {
        return DiscoveryProviderType.GOVERNMENT_REGISTRY;
    }
    ...
    public boolean enabled() {
        return discoveryProperties.isEnabled(DiscoveryProviderType.GOVERNMENT_REGISTRY);
    }
