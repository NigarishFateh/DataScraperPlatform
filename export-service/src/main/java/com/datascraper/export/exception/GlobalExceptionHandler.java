...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNotFound(ExportNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiError> handleNotReady(ExportNotReadyException ex, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiError.of(409, "export_not_ready", ex.getMessage(), request.getRequestURI()));
    }
