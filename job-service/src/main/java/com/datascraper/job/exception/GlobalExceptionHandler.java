...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleInvalidState(InvalidJobStateException ex, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiError.of(409, "invalid_job_state", ex.getMessage(), request.getRequestURI()));
    }
