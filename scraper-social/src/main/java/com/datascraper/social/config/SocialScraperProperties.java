/**
 * Holds settings like user agent, timeout, and robots.txt for social scraping.
 */
package com.datascraper.social.config;

import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties(prefix = "social.scraper")
public class SocialScraperProperties {
